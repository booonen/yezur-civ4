...
class CvGameUtils:
	...
	def cannotTrain(self,argsList):
		...
		bIgnoreUpgrades = argsList[5]
## Requirement Script ##
		#return max(False, Requirement.checkRequirements(eUnit, 0, pCity, pCity.getOwner()))
        return True
## Requirement Script ##
	...
	def cannotConstruct(self,argsList):
		...
		bIgnoreCost = argsList[4]
## Requirement Script ##
		return max(False, Requirement.checkRequirements(eBuilding, 1, pCity, pCity.getOwner()))
## Requirement Script ##
	...
	def cannotCreate(self,argsList):
		...
		bTestVisible = argsList[3]
## Requirement Script ##
		return max(False, Requirement.checkRequirements(eProject, 2, pCity, pCity.getOwner()))
## Requirement Script ##
