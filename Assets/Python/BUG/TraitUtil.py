...
def init():
	...
	addTrait("CHARISMATIC", gc.getYieldInfo(YieldTypes.YIELD_FOOD).getChar(), "Art/Interface/Buttons/TechTree/MassMedia.dds")
	...
	addTrait("IMPERIALIST", gc.getCommerceInfo(CommerceTypes.COMMERCE_ESPIONAGE).getChar(), "Art/Interface/Buttons/Actions/FoundCity.dds")
	...
	addTrait("RAIDER", game.getSymbolID(FontSymbols.OCCUPATION_CHAR), ",Art/Interface/Buttons/TechTree/Horseback Riding.dds,Art/Interface/Buttons/TechTree_Atlas.dds,6,4")
	addTrait("SCIENTIFIC", gc.getCommerceInfo(CommerceTypes.COMMERCE_RESEARCH).getChar(), ",Art/Interface/Buttons/TechTree/Chemistry.dds,Art/Interface/Buttons/TechTree_Atlas.dds,4,9")
