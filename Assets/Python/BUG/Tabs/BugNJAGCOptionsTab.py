...
class BugNJAGCOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		self.addColorDropdown(screen, rightPanelL, rightPanelR, "NJAGC__Color_ERA_INFORMATION", True)
		self.addColorDropdown(screen, rightPanelL, rightPanelR, "NJAGC__Color_ERA_NANOTECH", True)
		self.addColorDropdown(screen, rightPanelL, rightPanelR, "NJAGC__Color_ERA_CELESTIAL", True)
